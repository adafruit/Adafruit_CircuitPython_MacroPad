...
setup(
    ...
    url="https://github.com/adafruit/Adafruit_CircuitPython_MacroPad",
    # Author details
    ...
    keywords="adafruit macropad rp2040 mechanical keyboard breakout hardware"
    "micropython circuitpython",
    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    py_modules=["adafruit_macropad"],
)
